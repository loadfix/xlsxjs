...
export class WorkbookParser {
    ...
    parse(parts: Record<string, string>, media: Record<string, string> = {}): Workbook {
        ...
        for (let i = 0; i < sheetMeta.length; i++) {
            ...
            sheets.push(parseSheet(name, state, xml, sharedStrings, tables, images, charts, shapes, formControls, pivots, slicers, timelines, comments, threadedComments, hyperlinkTargets, i, definedNames, metadata));
        }
...
function parseSheet(
    ...
    return {
        ...
        charts, shapes, formControls, pivots, slicers, timelines, extensions, comments, threadedComments, view, outline,
