...
// Exercises the shape/connector surface: a text box anchored at B3:D5 with
// preset="rect" carrying a two-paragraph body, and a connector at A1:A3
// with preset="line". The drawing XML is hand-built (python-xlsx's
// spreadsheet_drawing surface is flaky for non-image anchors) — we wire
// xl/drawings/drawing1.xml into the sheet via the existing sheet-rels
// pattern. No media, no rels-to-drawing part (shape-only drawings don't
// need one).
{
...
<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">
  ...
  <Override PartName="/xl/drawings/drawing1.xml" ContentType="application/vnd.openxmlformats-officedocument.drawing+xml"/>
    ...
    // Sheet carries a drawing rel → xl/drawings/drawing1.xml.
    zip.file('xl/worksheets/_rels/sheet1.xml.rels', `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
  ...
  <drawing r:id="rId1"/>
    ...
    // Drawing with two twoCellAnchor entries:
    //   (1) xdr:cxnSp  connector A1 → A3, preset="line"
    //   (2) xdr:sp      text box B3 → D5, preset="rect",
    //                   txBody = "Line 1\nLine 2"
